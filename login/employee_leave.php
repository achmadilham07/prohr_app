<?php
	...
	function status(){
		...
		$text = "Anda telah mengajukan Cuti dengan keterangan $category_id - $notes untuk tanggal $date_begin sampai $date_end pada $date_created";

		$sql = "INSERT INTO `status`(`id`, `id_beacon`, `title`, `message`, `is_approved`, `date_modified`, `status_id`) VALUES (null, '$id_beacon', 'Leave', '$text', '0', '$date_created', '$rand_id')";
